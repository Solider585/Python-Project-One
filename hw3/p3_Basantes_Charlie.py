...
class Island (object):
    ...
    def __init__(self, n, prey_count=0, predator_count=0, human_count=0): #Humans added
    ...
    def init_animals(self,prey_count, predator_count,  human_count): #Humans added
...
###########################################
def main(human_breed_time = 4, human_starve_time = 3, intial_humans = 10, predator_breed_time=6, predator_starve_time=3, initial_predators=10, prey_breed_time=3, initial_prey=50, \
         size=10, ticks=1000):
